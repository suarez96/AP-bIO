...
def build_loaders(args, train: bool=True, test: bool=False, shuffle_test: bool=False, test_idxs: list=None):
    ...
    if train:
        train_idxs = constants.argsort_subject_ids_train[:int(args['yaml_args']['data']['train_samples'])]
    ...
    if test:
        if test_idxs is None: 
            test_idxs = constants.argsort_subject_ids_train[
                int(args['yaml_args']['data']['train_samples']):
            ] + constants.argsort_subject_ids_test
        else:
